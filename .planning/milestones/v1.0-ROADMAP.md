...
- [x] **Phase 1: Foundation** - Shared types, plugin trait, tree-sitter wrapper, CLI skeleton, build tooling, and CI (completed 2026-04-04)
- [x] **Phase 2: Infrastructure** - File discovery, git context detection, and variable resolution (completed 2026-04-04)
